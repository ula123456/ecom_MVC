...
<form method="post" action="" enctype="multipart/form-data">
	<table align="left" width="70%">
		...
		<td colspan="3"><input type="text" name="name" value="<?= $data_user['name']; ?>" required placeholder="Name"></td>
		</tr>

		<tr>
		<td width="15%"><b>Email:</b> </td>
		<td colspan="3"><input type="text" name="email" value="<?= $data_user['email']; ?>" required placeholder="email"></td>
		</tr>
		...
		<div>
			<img src="upload-files/<?= $data_user['image']; ?>" width="100" height="70"/>
		</div>
		</td>
		</tr>
		...
		<td colspan="3"><input type="text" name="city" value="<?= $data_user['city']; ?>" required placeholder="City"></td>
		</tr>

		<tr>
		<td width="15%"><b>Contact:</b> </td>
		<td colspan="3"><input type="text" name="contact" value="<?= $data_user['contact']; ?>" required placeholder="contact"></td>
		</tr>

		<tr>
		<td width="15%"><b>Address:</b> </td>
		<td colspan="3"><input type="text" name="address"  value="<?= $data_user['user_adress']; ?>" required placeholder="Address"></td>
		</tr>
